                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="relative">
                            <Textarea
                                ...
                                className="min-h-[60px] bg-transparent dark:bg-zinc-900/50 bg-white border dark:border-zinc-800 border-zinc-200 focus:border-zinc-400 dark:focus:border-zinc-600"
                            />
